...
get_header(); ?>
    ...
    <main class="basic">
        ...
        <section class="full-banner" style="background-image: url('<?php bloginfo('url'); ?>/wp-content/themes/krabo/assets/images/purity_banner2.jpg');">
            <div class="banner-tag-gray" style="z-index: 2;">
